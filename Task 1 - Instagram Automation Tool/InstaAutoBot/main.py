...
class UI:
	...
	def __init__(self, root):
		...
		photo = PhotoImage(file = "InstaAutoBot\\icon.png")
		self.root.iconphoto(False, photo)
		
		# Setting the Background of the Window
		self.bg = ImageTk.PhotoImage(file = "InstaAutoBot\\background.png")
		self.bg_image  =  Label(self.root, image = self.bg).place(x = 0 ,y =  0, relwidth  =  1, relheight =  1 )
		
		# Setting the Title Image on the Window
		self.title= ImageTk.PhotoImage(file = "InstaAutoBot\\title.png")
